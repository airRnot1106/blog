...
export const SiteHeader: FC<SiteHeaderProps> = memo(
  ({ className, ...rest }) => {
    return (
      <header
        className={twMerge(
      ...
      >
        ...
        <ul className="grid grid-cols-2 items-center justify-items-center">
          <li>
            <label className="swap swap-rotate btn btn-ghost @md:btn-lg hover:bg-muted/20">
          ...
          <li>
            <Link
              ...
              className="btn btn-ghost @md:btn-lg hover:bg-muted/20"
            >
