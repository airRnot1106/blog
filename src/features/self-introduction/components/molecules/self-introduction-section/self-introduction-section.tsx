...
export const SelfIntroductionSection: FC<SelfIntroductionSectionProps> = memo(
  ({ className, ...rest }) => {
    return (
      <section
        ...
        <div className="flex flex-col gap-y-4 items-center">
          ...
          <nav>
            <ul className="flex items-center justify-center text-[clamp(1rem,0.909rem_+_0.45vw,1.25rem)] [&>li:not(:last-child)]:after:content-['/'] [&>li:not(:last-child)]:after:mx-2">
              <li>
                <Link
                  href="https://github.com/airRnot1106"
                  className="btn-link"
                >
                  GitHub
                </Link>
...
SelfIntroductionSection.displayName = 'SelfIntroductionSection';
